...
namespace Ilab.KanSea.Chat.UI.Controls
{
    ...
    {
        #region 声明
        private Bitmap _TextBoxBackImg = ImageObject.GetResBitmap("Ilab.KanSea.Chat.UI.Resources.Textbox.png");
        ...
        #region 属性
        [Category("KanSea自定义属性"), Description("与控件关联的文本")]
        public string text
        {
            get
            {
        ...
        [Category("KanSea自定义属性"), Description("输入最大字符数")]
        ...
        [Category("KanSea自定义属性"), Description("将控件设为密码显示")]
        public bool IsPass
        {
            get
            {
        ...
        [Category("KanSea自定义属性"), Description("密码显示字符")]
        ...
        [Category("KanSea自定义属性"), Description("将控件设为多行文本显示")]
        ...
        [Category("KanSea自定义属性"), Description("将控件设为只读")]
        ...
        [Category("KanSea自定义属性"), Description("多行文本的编辑行")]
        public String[] lines
        {
            get
            {
        ...
        [Category("KanSea自定义属性"), Description("是否显示图标")]
        public bool Isico
        {
            get
            {
        ...
        [Category("KanSea自定义属性"), Description("图标文件")]
        public Bitmap Ico
        {
            get
            {
        ...
        [Category("KanSea自定义属性"), Description("图标文件Padding")]
