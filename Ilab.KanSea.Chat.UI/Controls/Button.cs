...
namespace Ilab.KanSea.Chat.UI.Controls
{
    ...
    public class Button : System.Windows.Forms.Button
    {
        ...
        public Bitmap _BackImg = ImageObject.GetResBitmap("Ilab.KanSea.Chat.UI.Resources.Botton.png");
        ...
        #region 属性
        [CategoryAttribute("KanSea自定义属性"), Description("按钮背景图片")]
        ...
        [CategoryAttribute("KanSea自定义属性"), Description("按钮背景光泽重绘边界")]
        ...
        [DefaultValue(true)]
        [CategoryAttribute("KanSea自定义属性"), Description("是否允许Tab焦点")]
